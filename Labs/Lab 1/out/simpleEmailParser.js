...
exports.SimpleEmailParser = void 0;
/**
...
class SimpleEmailParser {
    constructor() {
        ...
        // - \b: Word boundary (ensures we match complete words)
        this.emailPattern = /\b([a-zA-Z0-9]+)@torpedodepot\.(?:com|net|wannabemil)\b/g;
    }
    /**
...
exports.SimpleEmailParser = SimpleEmailParser;
//# sourceMappingURL=simpleEmailParser.js.map